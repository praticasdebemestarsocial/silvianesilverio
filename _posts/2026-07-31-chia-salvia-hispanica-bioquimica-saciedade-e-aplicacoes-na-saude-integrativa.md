...
image:
  path: /assets/img/posts/chia_saude_integrativa.jpg
  alt: "Chia (Salvia hispanica) — Bioquímica, Saciedade e Saúde Integrativa"
pin: false
toc: true
math: false
mermaid: true
...
```mermaid
graph TD
    A[SEMENTE SECA DE CHIA] -->|Ingestão de H2O / Líquido<br/>15 a 30 minutos| B[GEL DE MUCILAGEM VISCOSO]
    B --> C[Retardo do esvaziamento gástrico]
    B --> D[Absorção gradual da glicose]
    B --> E[Proteção e nutrição da mucosa]
```
