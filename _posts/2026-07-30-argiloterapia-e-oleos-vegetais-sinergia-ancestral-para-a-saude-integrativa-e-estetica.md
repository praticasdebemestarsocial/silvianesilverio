...
image:
  ...
  alt: "Argiloterapia e Óleos Vegetais — Sinergia Ancestral para a Saúde Integrativa e Estética"
pin: false
toc: true
math: false
mermaid: true
...
```mermaid
graph TD
    A[ARGILA: Minerais & Troca Iônica] --> C[SINERGIA INTEGRATIVA]
    B[ÓLEO VEGETAL: Nutrição & Ácidos Graxos] --> C
    C --> D[Desintoxicação + Regeneração da Barreira Cutânea]
```
